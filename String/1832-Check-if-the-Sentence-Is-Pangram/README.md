> 📌 **Cross-listed:** Primary location is [Hash Table/1832-Check-if-the-Sentence-Is-Pangram](../../Hash-Table/1832-Check-if-the-Sentence-Is-Pangram). This problem also appears under: **Hash Table**, **String**
...
| Metric | Value |
|:-------|:------|
| ⏱️ Runtime | 5 ms (Beats 8.52%) |
| 💾 Memory | 43.1 MB (Beats 34.24%) |
| 📅 Solved | 2026-06-11 |
| 💻 Language | Java |